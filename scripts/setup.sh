...
sudo apt-get -y -qq install mc curl wget git vim apt-transport-https ca-certificates
...
sudo usermod -a -G admins kostya
sudo cp /etc/sudoers /etc/sudoers.orig
echo "admins ALL=(ALL) NOPASSWD:ALL" | sudo tee /etc/sudoers.d/admins

# Installing SSH key
sudo mkdir -p /home/kostya/.ssh
sudo chmod 700 /home/kostya/.ssh
#curl http://10.20.213.200/authorized_keys -o /tmp/admins-keys.pub
#sudo cp /tmp/admins-keys.pub /home/kostya/.ssh/authorized_keys
#sudo chmod 600 /home/kostya/.ssh/authorized_keys
#sudo chown -R kostya /home/kostya/.ssh
sudo usermod --shell /bin/bash kostya
